...
case class CARSET(CAR: ch.bsisa.hyperbird.model.CARSET_CARType*)
 ...
 * MATRICE définit un bloc matricielle
 */
case class MATRICEType(L: ch.bsisa.hyperbird.model.L*) extends MATRICETypable
...
case class EVENEMENT(ECHEANCE: ch.bsisa.hyperbird.model.ECHEANCE*)
...
case class ANNEXE(RENVOI: ch.bsisa.hyperbird.model.RENVOI*)
